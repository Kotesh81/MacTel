dataset = xlsread('Report_Centre.xlsx',1, 'D1:D17');            % Reading data from the Excel file.
...
ylabel('Area of Deep Choroid')                          % Labelling y-axis as area
title('Deep Choroid');                                  % Title of the plot is  Deep Choroid
s = sum(y_axis);                                        
% fprintf ('%f\n',s)
