dataset = xlsread('Report_Centre.xlsx',1, 'B1:B17');            % Reading data from the Excel file.
...
ylabel('Area of Deep Retina')                           % Labelling y-axis as area
title('Deep Retina');                                   % Title of the plot is  Deep Retina
s = sum(y_axis);
% fprintf ('%f\n',s)
